...
<jsp:param name="pageTitle" value="Admin Dashboard Page"/>
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <div class="text-center">
            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="${pageContext.request.contextPath}/public/img/undraw_posting_photo.svg" alt="">
          </div>
