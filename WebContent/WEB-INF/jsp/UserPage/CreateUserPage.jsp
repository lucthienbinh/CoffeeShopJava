...
<jsp:param name="pageTitle" value="Create User Page"/>
<jsp:param name="pageHeading" value="Create New User"/>
</jsp:include>
         ...
         <div class="col-xl-6 col-lg-6">
           <div class="card shadow mb-4">
             ...
             <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
               <h6 class="m-0 font-weight-bold text-primary">Input New User Information</h6>
             </div>
             <!-- Card Body -->
             <div class="card-body">
         	<form method="post" action="./InsertUserServlet">
	    		<div class="row">
	    			<div class="col-md-12">
	    				...
	    				name="email" required="required" aria-describedby="basic-addon2">
	    			</div>
	    		</div>
	    		<br>
	    		<div class="row">
	    		...
	    		<div class="row">
	    			<div class="col-md-6">
	    				...
	    				name="firstname" aria-describedby="basic-addon2">
	    			</div>
	    			<div class="col-md-6">
	    				...
	    				name="lastname" aria-describedby="basic-addon2">
	    			</div>
	    		</div>
	    		<br>
	    		<div class="row">
	    			<div class="col-md-6">
	    				...
	    				name="sex" aria-describedby="basic-addon2">
	    			</div>
	    			<div class="col-md-6">
